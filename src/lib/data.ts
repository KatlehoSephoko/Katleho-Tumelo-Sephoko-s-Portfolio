export const personalInfo = {
  name: "Katleho Tumelo Sephoko",
  initials: "KTS",
  role: "Network Engineer • Software Developer",
  tagline: "Building connected systems and practical software solutions.",
  ...
  email: "contact@example.com", // Replace later
  github: "https://github.com", // Replace later
  linkedin: "https://linkedin.com", // Replace later
};
...
export const experience = [
  {
    ...
    role: "IT / Engineering Technical Experience",
    location: "Bloemfontein, South Africa",
    date: "Previous",
    highlights: ["IT technical environments", "Networking", "Troubleshooting", "Systems", "Engineering technology", "Hardware/software environments"]
  },
  {
    ...
    highlights: ["Customer service", "Communication", "Problem solving", "Understanding customer needs", "Product knowledge", "Sales"]
  }
];
...
export const education = [
  {
    ...
    date: "2019–2025",
    focus: ["Networking", "Infrastructure", "Systems", "IT", "Technical Troubleshooting"],
    status: "Completed"
  },
  {
    institution: "Central University of Technology",
